...
public class CAConvertTokenFilter extends TokenFilter {
	...
	public CAConvertTokenFilter(TokenStream in, CAConvertType convertType, String delimiter, Boolean keepBoth) {
		super(in);
